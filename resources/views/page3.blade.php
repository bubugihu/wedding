		...
		<div class="container">
			...
			<div class="couple-wrap animate-box">
				<div class="couple-half">
					<div class="groom">
						<img src="images/gr1.jpg" alt="groom" class="img-responsive">
					</div>
					<div class="desc-groom">
						<h3>Bubu</h3>
						<p>It starts with us. Ready to design my life.</p>
					</div>
				</div>
				<p class="heart text-center"><i class="icon-heart2"></i></p>
				<div class="couple-half">
					<div class="bride">
						<img src="images/br1.jpg" alt="groom" class="img-responsive">
					</div>
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>Traditional Wedding Ceremony <br> 237/12 Phan Van Han Street, Binh Thanh District, HCM City</p>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<p>The Gala Royale Event Hall. <br> 63 Mac Dinh Chi Street, Da Kao Sub-district, District 1, HCM City</p>
								</div>
							</div>
						</div>
					</div>
					...
					<ul class="timeline animate-box">
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								...
								<div class="timeline-body">
									<p>I don't think she remember it. I sure that.</p>
								</div>
							</div>
						</li>
						<li class="animate-box">
							...
							<div class="owl-carousel-fullwidth">
								<div class="item">
									<div class="testimony-slide active text-center">
										<figure>
											<img src="images/ex.jpg" alt="user">
										</figure>
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image:url(../images/img3.jpg);">
		...
		<div class="container">
            ...
            <div id="inCase" style="height: 50px;" class="row animate-box">
                <button id="cancel"  class="btn btn-default" >No, Im busy.</button>
            </div>
		</div>
	</div>
			...
			<div class="row copyright" >
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a >Bubu</a> Demo Images: <a >Bubu</a></small>
					</p>
				</div>
			</div>
